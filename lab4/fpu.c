...
double d[N][N], e[N][N], f[N][N];
long double g[N][N], reference[N][N];

void multiply_float(float a[N][N], float b[N][N], float c[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            for (int k = 0; k < N; k++) {
                c[i][j] += a[i][k] * b[k][j];
...
void multiply_double(double d[N][N], double e[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            for (int k = 0; k < N; k++) {
                f[i][j] += d[i][k] * e[k][j];
...
void multiply_float_sorted(float d[N][N], float e[N][N], float f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
...
void multiply_double_sorted(double d[N][N], double e[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
...
void multiply_float_sumator(float a[N][N], float b[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
...
void multiply_double_sumator(double d[N][N], double e[N][N], long double g[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
...
void multiply_float_kahana(float a[N][N], float b[N][N], float c[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            float suma = 0.0;
            float error = 0.0;   // Błąd akumulacji
            for (int k = 0; k < N; k++) {
                float y = d[i][k] * e[k][j] - error; // Obliczanie iloczynu z uwzględnieniem błędu
                float t = suma + y;
...
void multiply_double_kahana(double d[N][N], double e[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            double suma = 0.0;
...
void multiply_float_sorted_sumator(float a[N][N], float b[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            double akumulator[N]; // Tablica do przechowywania iloczynów
            for (int k = 0; k < N; k++) {
...
void multiply_double_sorted_sumator(double d[N][N], double e[N][N], long double g[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
...
void multiply_float_sumator_kahana(float a[N][N], float b[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            double suma = 0.0;
            double error = 0.0; // Błąd akumulacji
...
void multiply_double_sumator_kahana(double d[N][N], double e[N][N], long double g[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            long double suma = 0.0;
            long double error = 0.0; // Błąd akumulacji
            for (int k = 0; k < N; k++) {
                long double y = a[i][k] * b[k][j] - error; // Obliczanie iloczynu z uwzględnieniem błędu
...
void multiply_float_sorted_kahana(float a[N][N], float b[N][N], float c[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            float akumulator[N]; // Tablica do przechowywania iloczynów
            // Mnożenie macierzy
...
void multiply_double_sorted_kahana(double d[N][N], double e[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            double akumulator[N]; // Tablica do przechowywania iloczynów
            // Mnożenie macierzy
...
void multiply_float_sorted_sumator_kahana(float a[N][N], float b[N][N], double f[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            double akumulator[N]; // Tablica do przechowywania iloczynów
            for (int k = 0; k < N; k++) {
...
void multiply_double_sorted_sumator_kahana(double d[N][N], double e[N][N], long double g[N][N]) {
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            long double akumulator[N]; // Tablica do przechowywania iloczynów
            for (int k = 0; k < N; k++) {
...
void calculate_error(long double reference[N][N], float result[N][N], 
...
void calculate_error_double(long double reference[N][N], double result[N][N], 
...
void calculate_error_long(long double reference[N][N], long double result[N][N], 
...
void reset() {      // Reset macierze wynikowe
    for (int i = 0; i < N; i++) {
        for (int j = 0; j < N; j++) {
            c[i][j] = 0;
            f[i][j] = 0;
